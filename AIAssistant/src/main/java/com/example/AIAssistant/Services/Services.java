...
//    }
    ...
    private String buildPrompt(Request request) {
        ...
        switch (request.getOperation()) {
            case "summarize":
                prompt.append("You are an expert answering questions. Answer each question correctly only the correct options\n\n");
                prompt.append("Questions:\n");
                break;
//                prompt.append("Provide a clear and concise summary of the following text:\n\n");
//                break;
            case "suggest":
                prompt.append("Provide a suggestion for the following content:\n\n");
                break;
            case "answer":
                prompt.append("You are an expert answering questions. Answer each question correctly do not explain only the correct options\n\n");
                prompt.append("Questions:\n");
                break;
            default:
                throw new IllegalArgumentException("Unknown operation: " + request.getOperation());
